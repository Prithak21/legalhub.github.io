...
function avata_activate() {
	...
	if ( 'Avadanta' == $theme->name || 'Avadanta Business' == $theme->name || 'Avadanta Consulting' == $theme->name || 'Avadanta Corporate' == $theme->name || 'Avadanta Agency' == $theme->name || 'Avadanta Finance' == $theme->name || 'Avadanta Tech' == $theme->name || 'Avadanta Dark' == $theme->name || 'Avadanta Trade' == $theme->name || 'Avadanta Organization' == $theme->name  || 'Avadanta Industry' == $theme->name || 'Avadanta Invest' == $theme->name || 'Avadanta Deal' == $theme->name || 'Avadanta Firm' == $theme->name){
		...
		elseif('Avadanta Agency' == $theme->name || 'Avadanta Deal' == $theme->name || 'Avadanta Firm' == $theme->name){
		require_once('library/avadanta/default-data-agency.php');
		}
		elseif('Avadanta Corporate' == $theme->name || 'Avadanta Invest' == $theme->name){
		require_once('library/avadanta/default-data-corpo.php');
		}
		elseif('Avadanta Finance' == $theme->name ){
		require_once('library/avadanta/default-data-agency.php');
		}
		elseif('Avadanta Tech' == $theme->name || 'Avadanta Industry' == $theme->name){
		require_once('library/avadanta/default-data-consulting.php');
		}
		elseif('Avadanta Dark' == $theme->name || 'Avadanta Trade' == $theme->name || 'Avadanta Organization' == $theme->name){
		require_once('library/avadanta/default-data-business.php');
		}
...
elseif ( 'Teczilla' == $theme->name || 'Teczilla Consulting' == $theme->name || 'Teczilla Business' == $theme->name || 'Teczilla Agency' == $theme->name || 'Teczilla Corporate' == $theme->name || 'Teczilla startup' == $theme->name || 'Teczilla Finance' == $theme->name || 'Teczilla Dark' == $theme->name || 'Teczilla Creative' == $theme->name || 'Teczilla Trading' == $theme->name || 'Teczilla Portfolio' == $theme->name || 'Teczilla Organization' == $theme->name || 'Teczilla Industry' == $theme->name){
		...
		elseif('Teczilla Industry' == $theme->name){

			require_once('library/teczilla/default-data9.php');
		}	
